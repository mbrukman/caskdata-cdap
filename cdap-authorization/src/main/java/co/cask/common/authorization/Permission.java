...
public class Permission {
  ...
  public static final Permission CREATE = new Permission("create", new byte[]{0});
  public static final Permission READ = new Permission("read", new byte[]{1});
  public static final Permission WRITE = new Permission("write", new byte[]{2});
  public static final Permission EXECUTE = new Permission("execute", new byte[]{3});
  public static final Permission ADMIN = new Permission("admin", new byte[]{4});

  public static final Permission[] ALL = { CREATE, READ, WRITE, EXECUTE, ADMIN };
